...
def test_columnize_horizontal_vs_vertical():
    ...
    # use displaywidth 4
    assert columnize(
        dat4, opts={"displaywidth": 4, "arrange_vertical": False}
    ) == _strip("""
0  1
2  3
    """)
    assert columnize(
        dat4, opts={"displaywidth": 4, "arrange_vertical": True}
    ) == _strip("""
0  2
1  3
    """)
    ...
    # use displaywidth 7:
    assert columnize(
        dat4, opts={"displaywidth": 7, "arrange_vertical": False}
    ) == _strip("""
0  1  2
3
    """)
    ...
    assert columnize(
        dat4, opts={"displaywidth": 7, "arrange_vertical": True}
    ) == _strip("""
0  2
1  3
    """)
    ...
    assert columnize(
        dat100, opts={"displaywidth": 80, "arrange_vertical": False}
    ) == _strip("""
...
80  81  82  83  84  85  86  87  88  89  90  91  92  93  94  95  96  97  98  99
    """)
    assert columnize(
        dat100, opts={"displaywidth": 80, "arrange_vertical": True}
    ) == _strip("""
...
[ 0,  1,  2,  3,  4,  5,  6,  7,  8,
 ...
 54]
    ...
    assert columnize(
        data, displaywidth=39, ljust=False, colsep=", ", lineprefix="    "
    ) == _strip("""
